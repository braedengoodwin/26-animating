...
export default function WelcomePage() {
  ...
  // first array is number of pixels scrolled, second array is the value for things opacity, y post, x position, etc
  ...
  const yHero = useTransform(scrollY, [0, 200, 400, 600], [0, -150, -300, -600]);
